...
namespace Microsoft.Azure.SpatialAnchors
{
    ...
    /// </summary>
    public partial class OpenXrPlatformContext : ICachedObject
    {
        internal IntPtr handle;
        ...
        {
            this.handle = ahandle;
            if (!transfer) Microsoft.Azure.SpatialAnchors.NativeLibrary.ssc_open_xr_platform_context_addref(ahandle);
            Microsoft.Azure.SpatialAnchors.ProjectedObjectCache.Add(this);
        }
        ...
        internal static Microsoft.Azure.SpatialAnchors.OpenXrPlatformContext GetOrCreateInstance(ulong cookie, bool transfer)
            => Microsoft.Azure.SpatialAnchors.ProjectedObjectCache.GetOrCreate<Microsoft.Azure.SpatialAnchors.OpenXrPlatformContext>(
                cookie,
                _ => new Microsoft.Azure.SpatialAnchors.OpenXrPlatformContext(ConvertCookieToHandle(cookie), transfer: transfer));
