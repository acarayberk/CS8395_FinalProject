...
IL_003b:
	{
		...
		il2cpp_codegen_runtime_class_init_inline(RuntimeDebuggerOpenXRFeature_t1E3C60D2636DEC25D95E63BB3300DBFC5E9057BA_il2cpp_TypeInfo_var);
		bool L_9;
		L_9 = RuntimeDebuggerOpenXRFeature_Native_GetDataForRead_mB4B6D4D94B05795FA00E599CDD8754B5F9C719D1((&V_3), (&V_4), NULL);
		// Native_GetDataForRead(out var ptr2, out var size2);
		bool L_10;
		L_10 = RuntimeDebuggerOpenXRFeature_Native_GetDataForRead_mB4B6D4D94B05795FA00E599CDD8754B5F9C719D1((&V_5), (&V_6), NULL);
		...
		uint32_t L_16 = V_4;
		il2cpp_codegen_runtime_class_init_inline(Marshal_tD976A56A90263C3CE2B780D4B1CADADE2E70B4A7_il2cpp_TypeInfo_var);
		Marshal_Copy_m92700C9E60BAB2FDAF6CE02C16EFE9DCB7D6035E(L_14, L_15, 0, L_16, NULL);
		// if (size2 > 0)
		uint32_t L_17 = V_6;
	...
	}
	{
		...
		uint32_t L_22 = V_6;
		il2cpp_codegen_runtime_class_init_inline(Marshal_tD976A56A90263C3CE2B780D4B1CADADE2E70B4A7_il2cpp_TypeInfo_var);
		Marshal_Copy_m92700C9E60BAB2FDAF6CE02C16EFE9DCB7D6035E(L_19, L_20, L_21, L_22, NULL);
	}
...
IL_0080:
	{
		...
		L_23 = PlayerConnection_get_instance_m8F2B9C9F3AF41AC7A2FB617B5A700811E2444C14(NULL);
		...
		L_26 = PlayerConnection_get_instance_m8F2B9C9F3AF41AC7A2FB617B5A700811E2444C14(NULL);
