    ...
    public class PhotonRoom : MonoBehaviourPunCallbacks, IInRoomCallbacks
    {
        ...
        private void Start()
        {
            ...
            if (PhotonNetwork.PrefabPool is DefaultPool pool)
            {
               ...
               //if (eyeGazePrefab != null) pool.ResourceCache.Add(eyeGazePrefab.name, eyeGazePrefab);
        ...
        private void CreateInteractableObjects()
        {
            ...
            */
            ...
            var go = PhotonNetwork.Instantiate(monitorPrefab.name, position, AnchorPos.transform.rotation);
        }
